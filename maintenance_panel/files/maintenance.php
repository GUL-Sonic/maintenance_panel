...
//   Originaleinstellungen deaktivieren wenn MAINTENANCE-Panel verwendet wird
//--------------------------------------------------------------------------------------------------------------------------
...
//   Einstellungen für MAINTENACE-Panel
//--------------------------------------------------------------------------------------------------------------------------
include INFUSIONS . "maintenance_panel/infusion_db.php";
$result = dbquery("SELECT * FROM " . DB_GMT_MAINTENANCE . " WHERE id='1'");
$data = dbarray($result);

$grafikadress = $data['gmt_grafik'];
echo "<img src='".$grafikadress."' alt='".$settings['sitename']."' /><br /><br />\n";
echo stripslashes(nl2br($settings['maintenance_message']))."<br /><br />\n";
include INFUSIONS . "maintenance_panel/status.php";
